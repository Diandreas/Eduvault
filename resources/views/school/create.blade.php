                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Create') }} School</h1>
                            <p class="mt-2 text-sm text-gray-700">Add a new {{ __('School') }}.</p>
                        </div>
                    ...
                    <div class="flow-root">
                        <div class="mt-8 overflow-x-auto">
                            <div class="max-w-xl py-2 align-middle">
                                <form method="POST" action="{{ route('school.store') }}"  role="form" enctype="multipart/form-data">
                                    @csrf
