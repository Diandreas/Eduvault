                ...
                <div class="p-6 lg:p-8">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <a href="{{ route('courses.index') }}" class="flex items-center p-4 bg-white dark:bg-gray-700 rounded-lg shadow hover:bg-gray-50 dark:hover:bg-gray-600 transition">
                            ...
                            <a href="{{ route('grades.index') }}" class="flex items-center p-4 bg-white dark:bg-gray-700 rounded-lg shadow hover:bg-gray-50 dark:hover:bg-gray-600 transition">
